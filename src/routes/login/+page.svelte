...
<main class="login-page">
  ...
  <form onsubmit={unlock}>
    ...
    <input class="form-control" id="username" bind:value={username} maxlength="50" autocomplete="username" autocapitalize="none" spellcheck="false" />
    <label for="password">Password</label>
    <input class="form-control" id="password" type="password" bind:value={password} maxlength="128" autocomplete="current-password" />
