...
export { SquareTapInteraction, SquareSelectInteraction, TextEntryInteraction, MoveInteraction, BoardReconstructInteraction };
...
export const INTERACTIONS: Record<InteractionKind, AdapterComponent> = {
  ...
  'board-reconstruct': (BoardReconstructInteraction as unknown) as AdapterComponent
};
